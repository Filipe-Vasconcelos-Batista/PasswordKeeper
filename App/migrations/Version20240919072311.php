 ...
 */
final class Version20240919072311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE password ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_35C246D5A76ED395 ON password');
        $this->addSql('ALTER TABLE password DROP user_id');
    }
}
